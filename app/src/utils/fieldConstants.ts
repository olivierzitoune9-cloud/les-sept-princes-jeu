...
// Palette sobre : fond sombre, terrain clair, lignes fines, une couleur par equipe.
export const COLORS = {
  backdrop: '#0e141d',
  field: '#1b2432',
  fieldGradientTop: '#1e2836',
  fieldGradientBottom: '#151c27',
  lines: 'rgba(150, 172, 200, 0.5)',
  linesStrong: 'rgba(178, 198, 224, 0.85)',
  zone6m: 'rgba(59, 130, 246, 0.09)',
  zone6mLine: 'rgba(162, 192, 228, 0.72)',
  zone9m: 'rgba(122, 147, 178, 0.4)',
  nangis: '#3b82f6',
  nangisLight: '#7cb0fb',
  nangisSoft: 'rgba(59, 130, 246, 0.2)',
  lagny: '#ef4444',
  lagnyLight: '#f79a9a',
  lagnySoft: 'rgba(239, 68, 68, 0.18)',
  ball: '#fbbf24',
  ballLight: '#fde68a',
  selected: '#34d399',
  text: '#eef2f8',
